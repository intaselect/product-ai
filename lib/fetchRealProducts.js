...
if (country === "eg") {
  ...
  console.log("EGYPT GOOGLE SHOPPING DATA:", JSON.stringify(data, null, 2));
  console.log("EGYPT SHOPPING RESULTS COUNT:", data?.shopping_results?.length || 0);

  if (!data.shopping_results || data.shopping_results.length === 0) return [];
