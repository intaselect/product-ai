      ...
      shoppingResults = (fallbackData?.organic_results || [])
        ...
        .map((item) => ({
          ...
          price:
            ...
            "",
          source: item.source || item.displayed_link || "Google",
          thumbnail: item.thumbnail || "",
          link: item.link,
        }));
    }

    return mapShoppingResults(shoppingResults, country).map((item) => ({
      ...item,
      image:
        item.image ||
