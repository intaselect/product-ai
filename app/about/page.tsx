export default function AboutPage() {
  ...
  والإمارات ومصر والكويت وقطر والبحرين.
       ...
       <h2>هل يبيع BPS Chat المنتجات مباشرة؟</h2>

<p>
BPS Chat منصة للبحث عن المنتجات ومقارنة الأسعار واكتشاف العروض.
لا يقوم BPS Chat ببيع المنتجات أو تحصيل المدفوعات أو شحن الطلبات.
تتم عمليات الشراء مباشرة من المتاجر ومقدمي العروض المشاركين على المنصة.
</p>
